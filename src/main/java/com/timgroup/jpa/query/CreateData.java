...
public class CreateData extends Statement {
    ...
    protected void persistNewAuthor(EntityManager em, Random rnd, String name, Company company) {
    ...
    private String randomTicker(Random rnd) {
        String ticker;
    ...
    protected <T> T persist(EntityManager em, T entity) {
        em.persist(entity);
        return entity;
    }
    
    private int nextId(final Random rnd) {
